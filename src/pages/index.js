...
<section className="section section__online">
  ...
  <div className="absolute online__pic">
    <img src="/img/img--online.png" alt="img--online" className="img img--online"></img>
  </div>
  <div className="absolute online__ghostVertical">
    <img src="/img/ghost--vertical.png" alt="ghost--vertical" className="img img--ghostVertical"></img>
  </div>
  <div className="absolute online__ghostHorizontal">
    <img src="/img/ghost--horizontal.png" alt="ghost--horizontal" className="img img--ghostHorizontal"></img>
  </div>
</section>
...
<section className="section section__member">
  ...
  <div className="member__list member__slider">
    <div className="member__item">
      <div className="member__pic">
        <img src="/img/members--lovers.png" alt="img--member" className="img img--member"></img>
      </div>
      <div className="member__content">
        ...
        <div className="member__link">
          <a href="" className="link link-member">More</a>
        </div>
      </div>
    </div>
    <div className="member__item">
...
<section className="section section__join">
  ...
  <div className="join__pic absolute">
    <img src="./img/img--join.png" alt="img--join" className="img img--section"></img>
  </div>
</section>
...
<section className="section section__about">
  ...
  <div className="about__pic absolute">
    <img src="./img/img--about.png" alt="img--about" className="img img--section"></img>
  </div>
</section>
...
<section className="section section__catalog">
              ...
              <div className="catalog__descr">
                <div className="catalog__stat catalog__price">
                  <div className="catalog__pricePic">
                    <img src="./img/catalog--price.svg" alt="icon--price" className="icon icon--catalog"></img>
                  </div>
                ...
                <div className="catalog__stat catalog__length">
                  <div className="catalog__lengthPic">
                    <img src="./img/catalog--length.svg" alt="icon--price" className="icon icon--catalog"></img>
                  </div>
  ...
  <div className="catalog__pic absolute">
    <img src="./img/img--catalog.png" alt="img--catalog" className="img img--section"></img>
  </div>
</section>
...
<section className="section section__lecture">
  ...
  <div className="lecture__pic absolute">
    <img src="./img/img--lecture.png" alt="img--lecture" className="img img--section"></img>
  </div>
</section>
  ...
  <div className="container">
    <div className="mission">
      ...
      <div className="mission__pic">
        <img src="./img/img--mission.png" alt="img--mission" className="img img--mission"></img>
      </div>
    </div>
  </div>
</section>
...
<section className="section section__visit">
  ...
  <div className="visit__pic absolute">
    <img src="./img/img--visit.png" alt="img--visit" className="img img--visit"></img>
  </div>
</section>
